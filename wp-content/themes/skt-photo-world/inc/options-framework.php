...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Photo World Theme Options', 'optionsframework'),
		'menu_title' => __('Theme Options', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'photoworld-options',
...
function of_admin_head() {
	...
	do_action( 'skt_photo_world_optionsframework_custom_scripts' );
}
...
function optionsframework_page() {
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
    	<div style="padding-bottom:10px;"><a href="<?php echo esc_url(SKT_THEME_URL_DIRECT); ?>" target="_blank">Buy PRO version for only $30 with more features.</a></div>
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'SKT Photo World Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=skt_photo_world-options' )
		));
}
