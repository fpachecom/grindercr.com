...
jQuery(document).ready(function(){ 
	...
	jQuery('a.body-change').click(function(event){
        ...
        jQuery('#espace_bgimg').val('background-image:url('+imgUrl+'); background-attachment:fixed; background-position:0 50%; background-attachment:fixed; background-repeat:repeat;');
   });
   
   // headings font
	jQuery('#espace_google_font_name').change(function(){
    ...
    // paragraph
	jQuery('#espace_content_font_name').change(function(){
		var pfontVal = jQuery("#espace_content_font_name option:selected").val();
		// We will remove this tag and recreate it each time as IE don't want to correct modify of style tag content
