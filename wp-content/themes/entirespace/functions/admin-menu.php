...
function scom_create_menu() {
    ...
    add_menu_page('Entire Space Theme Settings', 'Entire Space Settings', 'administrator', 'theme_settings', 'scom_settings_page', $path.'img/favicon.png');
...
function register_mysettings() {
    // Page options
    register_setting( 'espace-settings-group', 'espace_gmap_html' );
    register_setting( 'espace-settings-group', 'espace_gcode' );
    register_setting( 'espace-settings-group', 'espace_user_buttons' );
    
    // Footer options
    register_setting( 'espace-settings-group', 'espace_copyright' );
    register_setting( 'espace-settings-group', 'espace_terms_link' );
    register_setting( 'espace-settings-group', 'espace_terms_link_show' );
    
    // Social oprions
    register_setting( 'espace-settings-group', 'espace_twitter' );
    register_setting( 'espace-settings-group', 'espace_gplus' );
    register_setting( 'espace-settings-group', 'espace_facebook' );
    register_setting( 'espace-settings-group', 'espace_flickr' );
    register_setting( 'espace-settings-group', 'espace_tumblr' );
    
    // Design options
    register_setting( 'espace-settings-group', 'espace_site_logo' );
    register_setting( 'espace-settings-group', 'espace_only_image' );
    register_setting( 'espace-settings-group', 'espace_only_text' );
    register_setting( 'espace-settings-group', 'espace_userbgimg' );
    register_setting( 'espace-settings-group', 'espace_bgimg' );
    register_setting( 'espace-settings-group', 'espace_bgcol' );
    register_setting( 'espace-settings-group', 'espace_google_font_name' );
    register_setting( 'espace-settings-group', 'espace_google_font_tags' );
    register_setting( 'espace-settings-group', 'espace_content_font_name' );	
    register_setting( 'espace-settings-group', 'espace_live_settings' );	
}
...
jQuery(document).ready(function(){
	...
	jQuery('#toeTemplateResetDesignSettings').click(function(){
		...
		jQuery(form).find('#espace_bgimg').val('');
		...
		jQuery(form).find('#espace_google_font_name').get(0).selectedIndex = 0;
		jQuery(form).find('#espace_google_font_name').trigger('change');
		
		jQuery(form).find('#espace_content_font_name').get(0).selectedIndex = 0;
		jQuery(form).find('#espace_content_font_name').trigger('change');
...
<div class="rt_wrap">
    <h2 id="rt_title"><?php lang::_e('Entire Space Theme Settings'); ?></h2>

    <form method="post" action="options.php" class="rt_opts" id="toeThemeEditOptionForm">

    <?php settings_fields('espace-settings-group'); ?>
    <div id="rt_tabs">
        <ul>
            <li class="rt_pages"><a href="#rt_pages"><?php lang::_e('Pages Options'); ?></a></li>
            <li class="rt_footer"><a href="#rt_footer"><?php lang::_e('Footer Options'); ?></a></li>
            <li class="rt_social"><a href="#rt_social"><?php lang::_e('Social Options'); ?></a></li>
        ...
        <div id="rt_pages">
            ...
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_gmap_html"><?php lang::_e('Google Maps HTML Code'); ?></label>
                    <small><?php lang::_e('Paste here HTML map code here. <br /> Set frame Width to 436px, Height - as you wish.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <textarea name="espace_gmap_html" id="espace_gmap_html"><?php echo esc_attr(get_option('espace_gmap_html')); ?></textarea>
                <div class="rt_clearfix"></div>
            </div>
            ...
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_gcode"><?php lang::_e('Google Analitics Code'); ?></label>
                    <small><?php lang::_e('Would be placed in header.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <textarea name="espace_gcode" id="espace_gcode" style="height:120px;"><?php echo esc_attr(get_option('espace_gcode')); ?></textarea>
                <div class="rt_clearfix"></div>
            </div>
            
            <div class="rt_input rt_checkbox">
                <div class="rt_description">
                    <label for="espace_user_buttons"><?php lang::_e('Hide Login and Register button'); ?></label>
                    <small><?php lang::_e('If checked - Login and Register buttons would be hidden.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_user_buttons" id="espace_user_buttons" type="checkbox" <?php if(get_option('espace_user_buttons') == 'on') echo "checked='checked'"; ?> />
                <div class="rt_clearfix"></div>
            </div>
        </div>
        <div id="rt_footer">
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_copyright"><?php lang::_e('Footer Copyright Text'); ?></label>
                    <small><?php lang::_e('Copyright text in the site footer.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_copyright" id="espace_copyright" type="text" value="<?php echo esc_attr(get_option('espace_copyright')); ?>" />
                <div class="rt_clearfix"></div>
            </div>
            
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_terms_link"><?php lang::_e('Footer Terms of Use Privacy Policy Link'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_terms_link" id="espace_terms_link" type="text" value="<?php echo esc_attr(get_option('espace_terms_link')); ?>" />
            </div>
            
            <div class="rt_input rt_checkbox">
                <div class="rt_description">
                    <label for="espace_terms_link_show"><?php lang::_e('Show Footer Terms of Use Privacy Policy Link'); ?></label>
                    <small><?php lang::_e('Show Footer Terms of Use Privacy Policy Link.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_terms_link_show" id="espace_terms_link_show" type="checkbox" <?php if(get_option('espace_terms_link_show') == 'on') echo "checked='checked'"; ?> />
                <div class="rt_clearfix"></div>
            </div>         
        </div>
        <div id="rt_social">
            <h3><?php lang::_e('Social Options'); ?></h3>
            
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_gplus"><?php lang::_e('Google+ link'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_gplus" id="espace_gplus" type="text" value="<?php echo esc_attr(get_option('espace_gplus')); ?>" />
                <div class="rt_clearfix"></div>
            </div>
            
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_twitter"><?php lang::_e('Twitter nickname'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_twitter" id="espace_twitter" type="text" value="<?php echo esc_attr(get_option('espace_twitter')); ?>" />
                <div class="rt_clearfix"></div>
            </div>

            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_facebook"><?php lang::_e('Facebook link'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_facebook" id="espace_facebook" type="text" value="<?php echo esc_attr(get_option('espace_facebook')); ?>" />
                <div class="rt_clearfix"></div>
            </div>

            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_flickr"><?php lang::_e('Flickr link'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_flickr" id="espace_flickr" type="text" value="<?php echo esc_attr(get_option('espace_flickr')); ?>" />
                <div class="rt_clearfix"></div>
            </div>   

            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_tumblr"><?php lang::_e('Tumblr link'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_tumblr" id="espace_tumblr" type="text" value="<?php echo esc_attr(get_option('espace_tumblr')); ?>" />
                <div class="rt_clearfix"></div>
            </div>
        </div>
        <div id="rt_design">
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_userbgimg"><?php lang::_e('Your own background image'); ?></label>
                    <small><?php lang::_e('You can choose our image below or write a link for your own.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input type="text" name="espace_userbgimg" id="espace_userbgimg" value="<?php echo esc_attr(get_option('espace_userbgimg')); ?>" />
                <div class="rt_clearfix"></div>
            </div>
            
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_bgimg"><?php lang::_e('Background image'); ?></label>
                    <div class="rt_clearfix"></div>
                </div>
                <textarea name="espace_bgimg" id="espace_bgimg"><?php echo esc_attr(get_option('espace_bgimg')); ?></textarea>
                <div class="rt_clearfix"></div>
            </div>
            <div class="left-bar">
                ...
                <input type="text" name="espace_bgcol" id="live-colorpicker" class="colorpicker" value="<?php if(get_option('espace_bgcol') != '') {echo esc_attr(get_option('espace_bgcol'));} else {echo $bgcolor;} ?>" />
            </div>
            <div class="right-bar">
            ...
            <div class="left-bar">
                ...
                <select name="espace_google_font_name" id="espace_google_font_name">
                    ...
                    foreach ($GoogleFontsArray as $font) {
                        if ($font == get_option('espace_google_font_name')) {$selected = ' selected="selected"';} else {$selected = '';}
                ...
                <select name="espace_content_font_name" id="espace_content_font_name">
                    <?php $ContentFontsArray = Array ("Select", "Arial, Helvetica, sans-serif", "'Arial Black', Gadget, sans-serif", "'Bookman Old Style', serif",
                        ...
                        foreach ($ContentFontsArray as $font) {
                            if ($font == get_option('espace_content_font_name')) {$selected = ' selected="selected"';} else {$selected = '';}
                            echo '<option value="'.$font.'" '.$selected.'>'.$font.'</option>';
                        }
                    ?>
                </select>
            ...
            <div class="rt_input rt_text">
                <div class="rt_description">
                    <label for="espace_google_font_tags"><?php lang::_e('Google font tags'); ?></label>
                    <small><?php lang::_e('Font will be used for these tags. Separate with commas. Default it can be using for h1, h2, h3'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input type="text" name="espace_google_font_tags" id="espace_google_font_tags" value="<?php echo esc_attr(get_option('espace_google_font_tags')); ?>" />
                <div class="rt_clearfix"></div>
            </div>
            
            <div class="rt_input rt_checkbox">
                <div class="rt_description">
                    <label for="espace_live_settings"><?php lang::_e('Show Live settings on frontend'); ?></label>
                    <small><?php lang::_e('Show Live settings block like on demo sites. Really, this option need only for demo sites.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_live_settings" id="espace_live_settings" type="checkbox" <?php if(get_option('espace_live_settings') == 'on') echo "checked='checked'"; ?> />
                <div class="rt_clearfix"></div>
            </div>
        ...
        <div id="rt_logo">
            ...
            <table class="form-table">
                <tr>
					<td>
                        <input id="site-logo" class="regular-text" type="hidden" name="espace_site_logo" value="<?php echo esc_attr(get_option('espace_site_logo')); ?>" />
                        <img id="image-logo" src="<?php echo esc_attr(get_option('espace_site_logo')); ?>" alt="<?php lang::_e('Site Logo')?>" /><br />
            ...
            <div class="rt_input rt_checkbox">
                <div class="rt_description">
                    <label for="espace_only_image"><?php lang::_e('Show only logo image'); ?></label>
                    <small><?php lang::_e('Show only image logo, without site name and description (hiding is SEO friendly).'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_only_image" id="espace_only_image" type="checkbox" <?php if(get_option('espace_only_image') == 'on') echo "checked='checked'"; ?> />
                <div class="rt_clearfix"></div>
            </div>
            
            <div class="rt_input rt_checkbox">
                <div class="rt_description">
                    <label for="espace_only_text"><?php lang::_e('Show only text logo'); ?></label>
                    <small><?php lang::_e('Show only text logo, without image logo.'); ?></small>
                    <div class="rt_clearfix"></div>
                </div>
                <input name="espace_only_text" id="espace_only_text" type="checkbox" <?php if(get_option('espace_only_text') == 'on') echo "checked='checked'"; ?> />
                <div class="rt_clearfix"></div>
            </div>
        </div>
        <div class="clear"></div>
...
if(isset($_POST) && !empty($_POST['resetSidebarToDefault'])) {
    update_option('theme_entirespace_widgets', 'default');
}
?>
