...
define( 'ADMIN_PATH', TEMPLATEPATH . '/functions/admin_responsive_slider/' );
define( 'ADMIN_DIR', get_template_directory_uri() . '/functions/admin_responsive_slider/' );
...
define( 'OPTIONS', 'toe_entirespace_options' );
