...
define( 'ADMIN_PATH', TEMPLATEPATH . '/functions/admin_slider/' );
define( 'ADMIN_DIR', get_template_directory_uri() . '/functions/admin_slider/' );
...
define( 'OPTIONS', 'entirespace_options' );
