...
$(document).ready(function(){
    $("#featured-products-slider").carouFredSel({
        width: "100%",
        responsive: true,
        auto: {play:false},
        items: {
        ...
        prev: {
            button  : "#featured-products-prev",
        },
        next: {
            button  : "#featured-products-next",
        },
        swipe: true
    });
});
...
<div class="bestsellers-widget toeWidget twelve columns" id="toeMostViewedWidgetContent<?php echo $this->uniqID?>">
    ...
    <div  class="products-slider list_carousel responsive">
        <ul class="content-slider" id="featured-products-slider">
        ...
        <a href="#" id="featured-products-prev" class="flex-prev prev"></a>
        <a href="#" id="featured-products-next" class="flex-next next"></a>
    </div>
