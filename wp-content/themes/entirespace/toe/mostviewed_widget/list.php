...
$(document).ready(function(){
    $("#most-viewed-slider").carouFredSel({
        width: "100%",
        responsive: true,
        auto: {play:false},
        items: {
        ...
        prev: {
            button  : "#most-viewed-prev",
        },
        next: {
            button  : "#most-viewed-next",
        },
        swipe: true
    });
});
...
<div class="bestsellers-widget toeWidget twelve columns" id="toeMostViewedWidgetContent<?php echo $this->uniqID?>">
    ...
    <div  class="products-slider list_carousel responsive">
        <ul class="content-slider" id="most-viewed-slider">
        ...
        <a href="#" id="most-viewed-prev" class="flex-prev prev"></a>
        <a href="#" id="most-viewed-next" class="flex-next next"></a>
    </div>
