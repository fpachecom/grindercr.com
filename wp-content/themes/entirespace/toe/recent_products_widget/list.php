...
$(document).ready(function(){
    $("#recent-products-slider").carouFredSel({
        width: "100%",
        responsive: true,
        auto: {play:false},
        items: {
        ...
        prev: {
            button  : "#recent-products-prev",
        },
        next: {
            button  : "#recent-products-next",
        },
        swipe: true
    });
});
...
<div class="bestsellers-widget toeWidget twelve columns" id="toeMostViewedWidgetContent<?php echo $this->uniqID?>">
    ...
    <div  class="products-slider list_carousel responsive">
        <ul class="content-slider" id="recent-products-slider">
        ...
        <a href="#" id="recent-products-prev" class="flex-prev prev"></a>
        <a href="#" id="recent-products-next" class="flex-next next"></a>
    </div>
