...
$(document).ready(function(){
    $("#bestsellers-slider").carouFredSel({
        width: "100%",
        responsive: true,
        auto: {play:false},
        items: {
        ...
        prev: {
            button  : "#bestsellers-prev",
        },
        next: {
            button  : "#bestsellers-next",
        },
        swipe: true
    });
});
...
<div class="bestsellers-widget toeWidget twelve columns" id="toeMostViewedWidgetContent<?php echo $this->uniqID?>">
    ...
    <div  class="products-slider list_carousel responsive">
        <ul class="content-slider" id="bestsellers-slider">
        ...
        <a href="#" id="bestsellers-prev" class="flex-prev prev"></a>
        <a href="#" id="bestsellers-next" class="flex-next next"></a>
    </div>
