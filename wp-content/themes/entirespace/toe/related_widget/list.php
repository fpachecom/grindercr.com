...
<div class="bestsellers-widget toeWidget twelve columns" id="toeRelatedWidgetContent<?php echo $this->uniqID?>">
    ...
    <div  class="products-slider list_carousel responsive">
        <ul class="content-slider" id="related-slider">
        ...
        <a href="#" id="related-prev" class="flex-prev prev"></a>
        <a href="#" id="related-next" class="flex-next next"></a>
    </div>
